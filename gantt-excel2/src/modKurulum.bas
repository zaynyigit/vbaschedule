...
Public Sub KurulumSifirla()
    ...
    adlar = Array(SH_GIRIS, SH_CIZELGE, SH_KULLANICILAR, SH_PROJELER, SH_KATEGORILER, _
                  SH_GOREVLER, SH_YORUMLAR, SH_GECIKMELER, SH_OFFGUNLER, SH_AYARLAR, _
                  SH_FOTOLAR, modModal.SH_MODAL)
...
Private Sub GirisSayfasiniKur()
    ...
    ' Shapes.SelectAll sayfa etkin degilse hata verir; hata yutuldugu icin eski
    ' sekiller kaliyor ve ikinci kurulumda panel ust uste ciziliyordu.
    ' Geriye dogru dolasip tek tek silmek her durumda calisir.
    Dim i As Long
    For i = ws.Shapes.Count To 1 Step -1
        ws.Shapes(i).Delete
    Next i
    ' Sekil silinince ActiveX kutusu da gider; kalan olursa diye ikinci tur
...
Private Sub OrnekVeriYukle()
    ...
    '--- Ornek gecikme kaydi ---
    modVeri.AyarYaz AYAR_OTURUM, 1      ' kaydeden bos kalmasin
