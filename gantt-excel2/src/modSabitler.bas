...
' Sagdaki iki sutun her zaman ayni yerdedir: ILERLEME = C_GUN1 + GUN_SAYISI_MAX,
' ACIKLAMA = bir sonrasi. Kisa aylarda fazla gun sutunlari gizlenir.
...
' Bos ya da bozuk renk geldiginde cizim ortasinda hata vermek yerine notr
' griye duser. Veri sayfasindaki bir satirda renk hucresi bos kaldiginda
' butun cizimin patlamasini bu engelliyor.
Public Const RENK_VARSAYILAN     As String = "64748B"

Public Function Hx(ByVal h As String) As Long
    Dim i As Long, c As String
    h = UCase$(Replace(Trim$(h), "#", ""))
    If Len(h) <> 6 Then
        h = RENK_VARSAYILAN
    Else
        For i = 1 To 6
